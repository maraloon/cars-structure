...
class CarsDrive extends UuidModel implements HasManyCars, Published
{
    use SoftDeletes;

    protected $table = Tables::CARS_DRIVES;
    ...
    {
        return $this->hasMany(config('cars_structure.car'), 'cars_drive_uuid');
    }
}
