...
class CarsColor extends UuidModel implements HasManyCars, Published
{
    use SoftDeletes;

    protected $table = Tables::CARS_COLORS;
    ...
    {
        return $this->hasMany(config('cars_structure.car'), 'cars_color_uuid');
    }
}
